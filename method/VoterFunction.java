...
public class VoterFunction{
    ...
    public void addVoter() throws IOException, ParseException, SQLException {
    ...
    public void displayAllVoter() throws IOException, ParseException, SQLException{
    ...
    public void displayOneVoter() throws IOException, ParseException, SQLException{
        ArrayList<Voter> voterList= VoterJDBC.readAllFromVoter();
        Scanner io=new Scanner(System.in);
        if (voterList!=null){
      ...
      public void editVoter() throws IOException, ParseException, SQLException{
        ArrayList<Voter> voterList = VoterJDBC.readAllFromVoter();
        Scanner io=new Scanner(System.in);
        if(voterList!=null){
    ...
    public void removeVoter() throws IOException, ParseException, SQLException{
        ArrayList<Voter> voterList= VoterJDBC.readAllFromVoter();
        Scanner io=new Scanner(System.in);
        if(voterList!=null){
...
public void voterTerminal() throws IOException, ParseException, SQLException{
    Scanner io=new Scanner(System.in);
