...
public class CandidateController {
    ...
    public void updateView(){
        view.printCandidateDetails(model.getNationalID(),model.getName(),model.getEmail(),model.getMobileNumber(),
                model.getPassword(),model.getAddress(),model.getGroup(),model.getZone(), model.isValid());
    }
}
